...
Route::get('/products/{id}', 'ProductController@show');   //Muestra info de producto
...
Route::middleware(['auth', 'admin'])->prefix('admin')->namespace('Admin')->group(function () {
    Route::get('/products', 'ProductController@index');            //listado, E, D
    ...
    Route::get('/categories', 'CategoryController@index');            //listado, E, D
